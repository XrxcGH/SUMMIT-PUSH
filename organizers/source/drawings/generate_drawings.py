...
dimension ledger. Run from anywhere:
    ...
    python3 organizers/source/drawings/generate_drawings.py   (writes participants/03-field/drawings/)

Every dimension below comes from participants/03-field/FIELD-CAD-PACKAGE.md §10
...
OUT = os.path.normpath(os.path.join(HERE, "..", "..", "..", "participants", "03-field", "drawings"))
