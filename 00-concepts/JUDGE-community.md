...
- Fixes:
  ...
  2. Prototype the Flare socket fit before anything else: make the socket 4 in over a 1.9-in post with a full-cone chamfer, and validate it with a kitbot-grade gripper before anything else is frozen. If capping success is under 60% for a decent arm, lower the High and Summit tips by 6 in.
