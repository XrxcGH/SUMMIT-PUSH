...
The JSON is generated from the inch table in §3 by `04-vision/make_layout.py`, and the two **match exactly**; `bash verify/run-all.sh` runs `make_layout.py --check`. Edit the table, then regenerate the JSON.
