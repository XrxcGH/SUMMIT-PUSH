...
(06-style/pdf/plates.css), so one user unit prints at 1512 / sheet-width pt.
...
Conventions (06-style/MANUAL-STYLE-GUIDE.md §7.3 and §7.4):
...
layout checker (verify/svg_collide.py) sees them as geometry.
"""
import math
