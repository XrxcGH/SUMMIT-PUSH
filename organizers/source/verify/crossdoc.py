...
DOCS = {
 'spec':   'organizers/design/DESIGN-SPEC.md',
 'arena':  'organizers/source/manual/sections/02-arena.md',
 'play':   'organizers/source/manual/sections/03-match-play.md',
 'rules':  'organizers/source/manual/sections/04-game-rules.md',
 'robot':  'organizers/source/manual/sections/05-robot-rules.md',
 'gloss':  'organizers/source/manual/sections/06-tournament-glossary.md',
 'cad':    'participants/03-field/FIELD-CAD-PACKAGE.md',
 'vision': 'participants/04-vision/VISION-GUIDE.md',
 'brief':  'participants/02-cadathon/CADATHON-BRIEF.md',
 'gen':    'organizers/source/drawings/generate_drawings.py',
 'mats':   'participants/03-field/MATERIALS-AND-COLORS.md',
}
T = {k: io.open(v, encoding='utf-8').read() for k, v in DOCS.items()}
SVG = {os.path.basename(p): io.open('participants/03-field/drawings/' + p, encoding='utf-8').read()
       for p in os.listdir('participants/03-field/drawings') if p.endswith('.svg')}
