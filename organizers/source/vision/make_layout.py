...
Generate apriltag-field-layout.json from the tag table in VISION-GUIDE.md §3.
    ...
    python3 organizers/source/vision/make_layout.py            write the JSON
    python3 organizers/source/vision/make_layout.py --check    exit 1 if the committed JSON differs
...
VISION = os.path.normpath(os.path.join(HERE, "..", "..", "..", "participants", "04-vision"))
GUIDE = os.path.join(VISION, "VISION-GUIDE.md")
OUT = os.path.join(VISION, "apriltag-field-layout.json")
IN = 0.0254
