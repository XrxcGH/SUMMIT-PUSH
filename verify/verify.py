...
IN = 0.0254
d = json.load(io.open('04-vision/apriltag-field-layout.json', encoding='utf-8'))
by = {t["ID"]: t for t in d["tags"]}

print("== AprilTag JSON vs manual table ==")
arena = io.open('02-manual/sections/02-arena.md', encoding='utf-8').read()
...
_arena = io.open('02-manual/sections/02-arena.md', encoding='utf-8').read()
_cad = io.open('03-field/FIELD-CAD-PACKAGE.md', encoding='utf-8').read()
