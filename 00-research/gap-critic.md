...
- The real 2026 element dimensions are the buildability benchmark: hub 47x47in with a 41.7in hex opening at 72in, tower rungs of 1.25in pipe at 27/45/63in, 6.5in bumps with 15-degree ramps, 22.25in trench clearance. They use round key heights, sheet goods and shallow standard angles (the fix for 2025's resented 35-degree reef branches).
...
Buildability benchmarks from the real 2026 elements ([frcmanual.com/2026/arena](https://www.frcmanual.com/2026/arena)): Hub = 47×47 in footprint, hex opening 41.7 in across at 72 in height; Tower rungs = 1.25 in pipe at 27/45/63 in (an even 18 in spacing, buildable as a ladder from pipe and lumber); Bumps = 6.513 in tall with 15° HDPE ramps; Trench under-clearance = 50.34 in wide × 22.25 in tall; Chute opening 31.8×7 in at 28.1 in. The pattern is that the key heights robots work to (the hub opening, the rungs) land on round values, structures break down into sheet goods and pipe, and ramp and branch angles are shallow standard angles. This answers the resentment over 2025's 35° reef branches. Design rule for the mock game: every scoring element must have a stated "team version" buildable from ≤2 sheets of plywood + hardware-store pipe, published with the manual.
...
- 36h11 family, IDs 1–32, 8.125 in square tag centered on a 10.5 in square polycarbonate panel (family and tag size consistent with 2024–25).
