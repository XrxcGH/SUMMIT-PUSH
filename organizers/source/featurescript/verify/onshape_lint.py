...
The two warnings the Onshape Feature Studio editor reports for this code, reproduced off-line:
    ...
    python organizers/source/featurescript/verify/onshape_lint.py [SummitPushField.fs]
...
def main():
    ...
    path = sys.argv[1] if len(sys.argv) > 1 else os.path.join(here, "..", "..", "..", "participants", "03-field", "onshape", "SummitPushField.fs")
