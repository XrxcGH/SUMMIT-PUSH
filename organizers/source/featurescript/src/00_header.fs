...
//
// GENERATED FILE — assembled by organizers/source/featurescript/build.py from src/*.fs and
// verified off-line by verify/run.py there.  Edit the sources, not this file.
// =====================================================================================
