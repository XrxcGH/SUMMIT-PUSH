...
Expected values come from the package documents only — never from src/:
  * participants/04-vision/apriltag-field-layout.json            (poses, metres + quaternions; parsed here)
  * organizers/source/manual/sections/02-arena.md §3.7             (tag table; parsed here)
  * participants/04-vision/VISION-GUIDE.md §1, §3, §6.6          (tag table parsed here; panel geometry,
                                                     mounting, occlusion budget, tag->target offsets)
  * participants/03-field/FIELD-CAD-PACKAGE.md §0, §2-§5, §7, §10 (panel 9.0 x 0.25, target 8.125, body 6.5,
                                                     Z 17.5 / 12 / 52, pairs +/-14, plane P, DEPOT)
  * participants/03-field/MATERIALS-AND-COLORS.md §1-§3          (neutral-white #F5F5F5, tag black #111111,
...
MANUAL_PATH = os.path.join(REPO, "organizers", "source", "manual", "sections", "02-arena.md")
VISION_PATH = os.path.join(REPO, "participants", "04-vision", "VISION-GUIDE.md")
